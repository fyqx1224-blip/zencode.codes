    ...
    for(let attempt=0; attempt<=maxRetries; attempt++){
      ...
      if(r.status === 429){
        ...
        const tick = setInterval(()=>{
          remaining--;
          if(phrEl) phrEl.textContent = `${t('err.ratelimit.wait')} ${remaining}s`;
        ...
        clearInterval(tick);
        if(phrEl) phrEl.textContent = t('err.ratelimit.retry');
        continue;
      }
...
══════════════════════════════════════════════════════ */
const TZ_OPTIONS = [
  { v:'+8',   'zh-TW':'UTC+8 · 中國大陸 / 台灣 / 香港 / 澳門 / 新加坡 / 馬來西亞',
               'zh-CN':'UTC+8 · 中国大陆 / 台湾 / 香港 / 澳门 / 新加坡 / 马来西亚',
               'en':   'UTC+8 · China / Taiwan / HK / Macau / Singapore / Malaysia',
               'ko':   'UTC+8 · 중국 / 대만 / 홍콩 / 마카오 / 싱가포르 / 말레이시아' },
  { v:'+9',   'zh-TW':'UTC+9 · 日本 / 韓國 / 東帝汶',
               'zh-CN':'UTC+9 · 日本 / 韩国 / 东帝汶',
               'en':   'UTC+9 · Japan / South Korea / Timor-Leste',
               'ko':   'UTC+9 · 일본 / 한국 / 동티모르' },
  { v:'+7',   'zh-TW':'UTC+7 · 泰國 / 越南 / 柬埔寨 / 老撾 / 印尼西部',
               'zh-CN':'UTC+7 · 泰国 / 越南 / 柬埔寨 / 老挝 / 印尼西部',
               'en':   'UTC+7 · Thailand / Vietnam / Cambodia / Laos / W. Indonesia',
               'ko':   'UTC+7 · 태국 / 베트남 / 캄보디아 / 라오스 / 인도네시아 서부' },
  { v:'+6',   'zh-TW':'UTC+6 · 孟加拉 / 哈薩克斯坦東部',
               'zh-CN':'UTC+6 · 孟加拉 / 哈萨克斯坦东部',
               'en':   'UTC+6 · Bangladesh / East Kazakhstan',
               'ko':   'UTC+6 · 방글라데시 / 동카자흐스탄' },
  { v:'+5.5', 'zh-TW':'UTC+5:30 · 印度 / 斯里蘭卡',
               'zh-CN':'UTC+5:30 · 印度 / 斯里兰卡',
               'en':   'UTC+5:30 · India / Sri Lanka',
               'ko':   'UTC+5:30 · 인도 / 스리랑카' },
  { v:'+5',   'zh-TW':'UTC+5 · 巴基斯坦 / 烏茲別克斯坦',
               'zh-CN':'UTC+5 · 巴基斯坦 / 乌兹别克斯坦',
               'en':   'UTC+5 · Pakistan / Uzbekistan',
               'ko':   'UTC+5 · 파키스탄 / 우즈베키스탄' },
  { v:'+4',   'zh-TW':'UTC+4 · 阿聯酋 / 阿曼 / 阿塞拜疆',
               'zh-CN':'UTC+4 · 阿联酋 / 阿曼 / 阿塞拜疆',
               'en':   'UTC+4 · UAE / Oman / Azerbaijan',
               'ko':   'UTC+4 · 아랍에미리트 / 오만 / 아제르바이잔' },
  { v:'+3',   'zh-TW':'UTC+3 · 沙特阿拉伯 / 土耳其 / 俄羅斯莫斯科 / 肯尼亞',
               'zh-CN':'UTC+3 · 沙特阿拉伯 / 土耳其 / 俄罗斯莫斯科 / 肯尼亚',
               'en':   'UTC+3 · Saudi Arabia / Turkey / Moscow / Kenya',
               'ko':   'UTC+3 · 사우디아라비아 / 터키 / 모스크바 / 케냐' },
  { v:'+2',   'zh-TW':'UTC+2 · 以色列 / 南非 / 埃及 / 東歐',
               'zh-CN':'UTC+2 · 以色列 / 南非 / 埃及 / 东欧',
               'en':   'UTC+2 · Israel / South Africa / Egypt / Eastern Europe',
               'ko':   'UTC+2 · 이스라엘 / 남아프리카 / 이집트 / 동유럽' },
  { v:'+1',   'zh-TW':'UTC+1 · 西歐夏令時（英法德意）/ 西非',
               'zh-CN':'UTC+1 · 西欧夏令时（英法德意）/ 西非',
               'en':   'UTC+1 · Western Europe DST (UK/FR/DE/IT) / W. Africa',
               'ko':   'UTC+1 · 서유럽 서머타임(영국/프랑스/독일) / 서아프리카' },
  { v:'+0',   'zh-TW':'UTC+0 · 英國（冬季）/ 愛爾蘭 / 葡萄牙 / 冰島',
               'zh-CN':'UTC+0 · 英国（冬季）/ 爱尔兰 / 葡萄牙 / 冰岛',
               'en':   'UTC+0 · UK (winter) / Ireland / Portugal / Iceland',
               'ko':   'UTC+0 · 영국(겨울) / 아일랜드 / 포르투갈 / 아이슬란드' },
  { v:'-1',   'zh-TW':'UTC-1 · 佛得角 / 葡萄牙亞速爾群島',
               'zh-CN':'UTC-1 · 佛得角 / 葡萄牙亚速尔群岛',
               'en':   'UTC-1 · Cape Verde / Azores (Portugal)',
               'ko':   'UTC-1 · 카보베르데 / 아조레스' },
  { v:'-2',   'zh-TW':'UTC-2 · 巴西費爾南多迪諾羅尼亞島',
               'zh-CN':'UTC-2 · 巴西费尔南多迪诺罗尼亚岛',
               'en':   'UTC-2 · Fernando de Noronha (Brazil)',
               'ko':   'UTC-2 · 페르난도 데 노로냐 (브라질)' },
  { v:'-3',   'zh-TW':'UTC-3 · 巴西東部（聖保羅/里約）/ 阿根廷',
               'zh-CN':'UTC-3 · 巴西东部（圣保罗/里约）/ 阿根廷',
               'en':   'UTC-3 · E. Brazil (São Paulo/Rio) / Argentina / Uruguay',
               'ko':   'UTC-3 · 브라질 동부(상파울루/리우) / 아르헨티나' },
  { v:'-4',   'zh-TW':'UTC-4 · 加拿大大西洋省份 / 委內瑞拉 / 智利',
               'zh-CN':'UTC-4 · 加拿大大西洋省份 / 委内瑞拉 / 智利',
               'en':   'UTC-4 · Atlantic Canada / Venezuela / Chile',
               'ko':   'UTC-4 · 캐나다 대서양 / 베네수엘라 / 칠레' },
  { v:'-5',   'zh-TW':'UTC-5 · 美國東部（EST）/ 加拿大安大略 / 秘魯',
               'zh-CN':'UTC-5 · 美国东部（EST）/ 加拿大安大略 / 秘鲁',
               'en':   'UTC-5 · US Eastern (EST) / Ontario Canada / Peru',
               'ko':   'UTC-5 · 미국 동부(EST) / 온타리오 캐나다 / 페루' },
  { v:'-6',   'zh-TW':'UTC-6 · 美國中部（CST）/ 墨西哥城 / 中美洲',
               'zh-CN':'UTC-6 · 美国中部（CST）/ 墨西哥城 / 中美洲',
               'en':   'UTC-6 · US Central (CST) / Mexico City / Central America',
               'ko':   'UTC-6 · 미국 중부(CST) / 멕시코시티 / 중앙아메리카' },
  { v:'-7',   'zh-TW':'UTC-7 · 美國山地（MST）/ 亞利桑那',
               'zh-CN':'UTC-7 · 美国山地（MST）/ 亚利桑那',
               'en':   'UTC-7 · US Mountain (MST) / Arizona',
               'ko':   'UTC-7 · 미국 산악(MST) / 애리조나' },
  { v:'-8',   'zh-TW':'UTC-8 · 美國西部（PST）/ 加拿大英屬哥倫比亞',
               'zh-CN':'UTC-8 · 美国西部（PST）/ 加拿大不列颠哥伦比亚',
               'en':   'UTC-8 · US Pacific (PST) / British Columbia Canada',
               'ko':   'UTC-8 · 미국 태평양(PST) / 브리티시컬럼비아 캐나다' },
  { v:'-9',   'zh-TW':'UTC-9 · 美國阿拉斯加',
               'zh-CN':'UTC-9 · 美国阿拉斯加',
               'en':   'UTC-9 · Alaska (USA)',
               'ko':   'UTC-9 · 알래스카 (미국)' },
  { v:'-10',  'zh-TW':'UTC-10 · 夏威夷 / 法屬波利尼西亞',
               'zh-CN':'UTC-10 · 夏威夷 / 法属波利尼西亚',
               'en':   'UTC-10 · Hawaii / French Polynesia',
               'ko':   'UTC-10 · 하와이 / 프랑스령 폴리네시아' },
  { v:'-12',  'zh-TW':'UTC-12 · 貝克島 / 豪蘭島',
               'zh-CN':'UTC-12 · 贝克岛 / 豪兰岛',
               'en':   'UTC-12 · Baker Island / Howland Island',
               'ko':   'UTC-12 · 베이커 섬 / 하울랜드 섬' },
  { v:'+10',  'zh-TW':'UTC+10 · 澳大利亞東部（悉尼/墨爾本）/ 巴布亞新幾內亞',
               'zh-CN':'UTC+10 · 澳大利亚东部（悉尼/墨尔本）/ 巴布亚新几内亚',
               'en':   'UTC+10 · E. Australia (Sydney/Melbourne) / Papua New Guinea',
               'ko':   'UTC+10 · 호주 동부(시드니/멜버른) / 파푸아뉴기니' },
  { v:'+11',  'zh-TW':'UTC+11 · 所羅門群島 / 瓦努阿圖',
               'zh-CN':'UTC+11 · 所罗门群岛 / 瓦努阿图',
               'en':   'UTC+11 · Solomon Islands / Vanuatu',
               'ko':   'UTC+11 · 솔로몬 제도 / 바누아투' },
  { v:'+12',  'zh-TW':'UTC+12 · 紐西蘭 / 斐濟 / 基里巴斯',
               'zh-CN':'UTC+12 · 新西兰 / 斐济 / 基里巴斯',
               'en':   'UTC+12 · New Zealand / Fiji / Kiribati',
               'ko':   'UTC+12 · 뉴질랜드 / 피지 / 키리바시' },
];
...
function renderTzOptions(){
  ...
  sel.innerHTML = TZ_OPTIONS.map(o =>
    `<option value="${o.v}"${o.v===cur?' selected':''}>${o[lang]||o['zh-TW']}</option>`
  ).join('');
}

// 初始渲染
document.addEventListener('DOMContentLoaded', renderTzOptions);
// 若已加载完成则立即渲染
if(document.readyState !== 'loading') renderTzOptions();
